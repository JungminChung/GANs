...
class Generator(nn.Module):
    def __init__(self, z_dim, init_height, init_width, ngf):
        ...
        self.convT4 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=self.ngf*1, out_channels=3, kernel_size=4, stride=2, padding=1, bias=False),
            nn.Tanh(),
        )
